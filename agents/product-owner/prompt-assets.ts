...
const PRODUCT_OWNER_RELEASE_1_0_2_BUNDLE_HASH =
...
export function parseProductOwnerPromptAssets(
  ...
  try {
    ...
    assertEqual(
      bundleHash,
      PRODUCT_OWNER_RELEASE_1_0_2_BUNDLE_HASH,
      'O conteúdo do bundle não corresponde ao release Product Owner 1.0.2.',
    );
