  ...
  return immutableClone(
    persistedFactoryResultSchema.parse({
      ...
      lineage: {
        ...
        executionProfileHash: result.lineage.executionProfileHash,
        generationProjectionHash: result.lineage.generationProjectionHash,
        profileValidationHash: result.lineage.profileValidationHash,
        factoryResultHash: result.hashes.factoryResultHash,
      },
      provenance: {
        ...
        executionProfileId: result.provenance.executionProfile.profileId,
        executionProfileVersion: result.provenance.executionProfile.version,
        executionProfileContractVersion: result.provenance.executionProfile.contractVersion,
        executionProfileHash: result.provenance.executionProfile.profileHash,
        generationProjectionHash: result.provenance.executionProfile.generationProjectionHash,
        profileValidationHash: result.provenance.executionProfile.profileValidationHash,
